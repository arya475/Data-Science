...
data = {
    ...
    'cp': st.sidebar.selectbox("Tipe Nyeri Dada (0-3)", [0, 1, 2, 3]),
    'trestbps': st.sidebar.number_input("Tekanan Darah", 90, 200, 120),
    'chol': st.sidebar.number_input("Kolesterol", 100, 400, 200),
    'fbs': st.sidebar.selectbox("Gula Darah Puasa > 120 mg/dl", [0, 1]),
    'restecg': st.sidebar.selectbox("Hasil Elektrokardiografi", [0, 1, 2]),
    'thalach': st.sidebar.number_input("Detak Jantung Maksimum", 60, 220, 150),
    'exang': st.sidebar.selectbox("Angina Akibat Latihan", [0, 1]),
    'oldpeak': st.sidebar.number_input("Oldpeak (depresi ST)", 0.0, 10.0, 1.0),
    'slope': st.sidebar.selectbox("Slope", [0, 1, 2]),
    'ca': st.sidebar.selectbox("Jumlah Pembuluh Darah Utama", [0, 1, 2, 3]),
